...
const Navbar = () => {
  return (
    <>
      <div className="text-center py-5 bg-[#f6f5f4] font-inter">
        <span className="pt-[1px] pr-[7px] pb-[2px] pl-[8px] rounded-[100px] bg-[#8029B3] text-white mr-2  ">New</span>
        ...
        <div className="flex items-center font-inter font-bold">
          ...
          <div className="flex items-center">
            <div className="flex items-center pl-[10px] pr-[24px] text-[0.9375rem] font-medium ">
              Product
              <img src={arrowDown} width={12} className="mt-[4px] ml-[3px]" />
            </div>
